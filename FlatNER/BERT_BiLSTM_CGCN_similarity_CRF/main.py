...
py_logging.basicConfig(
    ...
    handlers=[
        py_logging.FileHandler("/home/user/swun/Maping/Ablation_experiment/BERT_BiLSTM_CGCN_Laynorm_CRF/Logging/BERT_BiLSTM_GCN_BN_CRF_EDA.log"),
...
def train_and_evaluate(epochs, model_dir, device):
    ...
    dataset = Dataset()
    loader = data.DataLoader(dataset, batch_size=32, shuffle=True, collate_fn=collate_fn, num_workers=16)
...
def evaluate(model, device):
    ...
    loader = data.DataLoader(dataset, batch_size=32, collate_fn=collate_fn, num_workers=16)
